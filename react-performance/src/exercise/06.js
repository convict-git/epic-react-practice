...
const dogReducer = (state, action) => {
  switch (action.type) {
    case dogActionTypes.TYPED_IN_DOG_INPUT: {
...
const useDogContext = () => {
  ...
  if (!context) {
    throw new Error('DogContext used outside DogProvider')
  }
  return context
}
...
function DogNameInput() {
  ...
  function handleChange(event) {
    ...
    dispatch({type: dogActionTypes.TYPED_IN_DOG_INPUT, dogName: newDogName})
